...
def get_db_manager(
    ...
    # If DB path changed, recreate the manager
        ...
        logger.info(f"Database path changed, recreating manager. Old: {_default_manager.db_url}, New: sqlite:///{db_path}")
...
def init_db_manager():
    ...
    if db_path and os.path.exists(db_path):
        ...
        logger.error(f"Cannot initialize DB manager: {db_path} does not exist or is not set")
