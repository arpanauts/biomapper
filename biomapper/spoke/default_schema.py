...
SPOKE_DEFAULT_SCHEMA = {
    ...
    "schema_mapping": {
        "node_types": {
            "Compound": {
                "ontology_types": ["chebi", "hmdb", "pubchem", "inchikey", "drugbank", "chembl"],
                "property_map": {
                ...
                "source_databases": ["ChEMBL", "DrugBank", "DrugCentral", "BindingDB", "FooDB"]
            },
            "Gene": {
                ...
                "source_databases": ["Entrez Gene", "COSMIC", "DisGeNET", "DistiLD", "OMIM", "Bgee", "LINCS L1000"]
            },
            "Protein": {
            ...
            "Pathway": {
                ...
                "source_databases": ["Reactome", "Pathway Commons", "Pathway Interaction Database"]
            },
            "Anatomy": {
                "ontology_types": ["uberon"],
                "property_map": {
                    "properties.uberon": "uberon"
                }
            },
            "Symptom": {
    ...
    "capabilities": [
        ...
        },
        {
            ...
            "confidence": 0.9,
            "expected_labels": ["ASSOCIATES_DaG", "UPREGULATES_GuD", "DOWNREGULATES_GdD"],
