...
class NodeTypeMetadata:
    ...
    potential_identifiers: Dict[str, IdentifierConfidence] = field(default_factory=dict)  # Potential ontology IDs
...
class GraphSchemaMapping:
    ...
    node_type_mappings: List[OntologyTypeMapping] = field(default_factory=list)  # Node mappings
    relationship_mappings: Dict[str, Dict[str, str]] = field(default_factory=dict)  # Relationship mappings
