...
try:
    ...
    HAS_FAISS = False
    logging.warning(
        "faiss-cpu package not found. FAISSVectorStore will not work correctly."
    )
...
class FAISSVectorStore(BaseVectorStore):
    ...
    def _initialize(self):
        ...
        if not HAS_FAISS:
            logging.error(
                "FAISS is not available. Please install faiss-cpu or faiss-gpu."
            )
            self.index = None
            self.metadata = {}
            self.id_to_index = {}
        ...
        try:
            ...
            if self.index_path and os.path.exists(self.index_path):
                ...
                if self.metadata_path and os.path.exists(self.metadata_path):
                    ...
                    self.id_to_index = {
                        id: idx for idx, id in enumerate(self.metadata.keys())
                    }
