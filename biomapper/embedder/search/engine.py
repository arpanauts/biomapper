...
class EmbedderSearchEngine:
    ...
    def format_results(self, results: List[Dict[str, Any]], format_type: str = "text") -> Union[str, List[Dict]]:
            ...
            for i, result in enumerate(results):
                ...
                # Generic fallback for other types
                    ...
                    for key, value in metadata.items():
                        if key not in ["id", "type", "source"] and isinstance(value, (str, int, float)):
