...
class PubChemRAGMappingClient(BaseMappingClient):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.collection_name = self.get_config_value(
    ...
    def _initialize_clients(self):
        ...
        try:
            ...
            logger.info(
                f"Connected to Qdrant collection '{self.collection_name}' with {collection_info.points_count} points"
            )
            ...
            try:
                ...
                if search_results:
                    ...
                    if target_cids:
                        ...
                        logger.info(
                            f"Found {len(target_cids)} mappings for '{identifier}' (top score: {best_score:.3f})"
                        )
                    else:
                        results[identifier] = self.format_result(None, None)
                        mapping_result_items.append(
    ...
    async def reverse_map_identifiers(
        ...
        raise NotImplementedError(
            "PubChemRAGMappingClient does not support reverse mapping"
        )
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "error": str(e), "qdrant_connected": False}
