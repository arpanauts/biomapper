...
from biomapper.mapping.metadata.interfaces import BaseResourceAdapter, KnowledgeGraphClient
...
class SpokeClient:
    ...
    def _is_same_entity_mapping(self, source_type: str, target_type: str) -> bool:
        ...
        compound_identifiers = {'chebi', 'hmdb', 'pubchem', 'drugbank', 'inchikey', 'compound_name'}
