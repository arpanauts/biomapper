...
def test_dataset_loading():
    ...
    if spoke_file.exists():
        ...
        print("   📝 Pattern: Bare UniProt IDs (no prefix)\n")
    ...
    if kg2c_file.exists():
        ...
        print("   📝 Pattern: Prefix stripped, original preserved\n")
    ...
    if ukbb_file.exists():
        ...
        print("   📝 Pattern: Capitalized column name\n")
    ...
    if hpa_file.exists():
        ...
        print(f"   📋 Columns: {list(df.columns)}")
        print(f"   🔍 Sample identifiers: {df['uniprot'].head(3).tolist()}")
        print("   📝 Pattern: Lowercase column name\n")
    ...
    print(
        "Now you can proceed with testing the actual LOAD_DATASET_IDENTIFIERS action."
    )
