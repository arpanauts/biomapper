...
import pytest
from biomapper.mapping.chebi_client import ChEBIClient, ChEBIResult
...
def test_get_entity_by_id_success(chebi_client: ChEBIClient, mock_entity: Mock) -> None:
    ...
    with patch("biomapper.mapping.chebi_client.ChebiEntity") as mock_chebi:
...
def test_get_entity_missing_properties(
    ...
    with patch("biomapper.mapping.chebi_client.ChebiEntity", return_value=mock_entity):
        result = chebi_client.get_entity_by_id("12345")
        assert result.chebi_id == "CHEBI:12345"
