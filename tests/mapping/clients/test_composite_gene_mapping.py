...
async def test_composite_gene_symbols():
    ...
    print(f"Successfully mapped {mapped_count}/{len(COMPOSITE_GENES)} composite gene symbols")
    
    # We should have at least some successful mappings
    assert mapped_count > 0, "Expected at least some composite gene symbols to map successfully"
