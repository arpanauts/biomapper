...
///"""
        ...
        with patch.object(self.client.session, 'get') as mock_get:
            ...
            # Verify the result
            self.assertEqual(result.kegg_id, "C00031")
            self.assertEqual(result.name, "D-Glucose")
...
///"""
        ...
        with patch.object(self.client.session, 'get') as mock_get:
            ...
            self.assertEqual(results[0].kegg_id, "C00031")
            self.assertEqual(results[0].name, "D-Glucose")
