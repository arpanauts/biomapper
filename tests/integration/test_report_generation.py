...
class TestReportGenerationIntegration:
    ...
    async def test_report_with_custom_baseline(self, temp_dir, realistic_metrics):
        ...
        assert "15.6% relative improvement" in content or "16% relative improvement" in content
    ...
    async def test_report_directory_creation(self, temp_dir):
        ...
        nested_path = os.path.join(temp_dir, "reports", "metabolomics", "enhancement_report.md")
        ...
        context = {
            "metrics.test": {"match_rate": 0.5, "total_matched": 50}
        }
