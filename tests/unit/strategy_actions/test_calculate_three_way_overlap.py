...
class TestCalculateThreeWayOverlapAction:
    ...
    def test_membership_extraction(self, action, sample_three_way_matches, sample_two_way_matches):
    ...
    def test_pairwise_overlap_calculation(self, action, sample_three_way_matches, sample_two_way_matches):
    ...
    def test_three_way_overlap_calculation(self, action, sample_three_way_matches, sample_two_way_matches):
    ...
    def test_jaccard_index_calculation(self, action, sample_three_way_matches, sample_two_way_matches):
    ...
    def test_confidence_filtering(self, action, sample_three_way_matches, sample_two_way_matches):
    ...
    def test_visualization_generation(self, mock_figure, mock_savefig, mock_heatmap, action, temp_dir):
    ...
    def test_export_functionality(self, mock_to_csv, action, temp_dir, 
                                 sample_three_way_matches, sample_two_way_matches):
    ...
    def test_complex_overlap_scenarios(self, action):
        ...
        # Verify memberships
        assert len(memberships["Israeli10K"]) == 4  # 3way, i10k_ukbb, i10k_arivale, i10k_only
