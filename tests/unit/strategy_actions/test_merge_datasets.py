...
class TestMergeDatasetsAction:
    ...
    async def test_empty_dataset_handling(self, action):
        ...
        context.set_action_data(
            "datasets",
            {"empty_dataset": [], "valid_dataset": [{"id": "1", "name": "Test"}]},
        )
    ...
    def test_params_validation(self):
        ...
        # Valid params
        params = MergeDatasetsParams(dataset_keys=["ds1", "ds2"], output_key="output")
        ...
        with pytest.raises(ValueError):
            MergeDatasetsParams(
                dataset_keys=["ds1"], output_key="output", keep="invalid"
            )
