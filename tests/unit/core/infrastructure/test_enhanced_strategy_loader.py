...
from biomapper.core.infrastructure.enhanced_strategy_loader import (
    EnhancedStrategyLoader, StrategyLoadError, StrategyValidationError, PathResolver
)
...
class TestEnhancedStrategyLoader:
    ...
    def test_circular_parameter_reference_detection(self, loader):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.yaml', delete=False) as f:
            ...
            from biomapper.core.infrastructure.parameter_resolver import CircularReferenceError
        ...
        if configs_dir.exists():
            ...
            if strategies:
                ...
                try:
                    ...
                    loaded_strategy = loader.load_strategy(first_strategy['name'], validate=False)
                    ...
                    print(f"Note: Could not load real strategy {first_strategy['name']}: {e}")
