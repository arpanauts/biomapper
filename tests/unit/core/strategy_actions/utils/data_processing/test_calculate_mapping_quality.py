...
class TestCalculateMappingQualityAction:
    ...
    async def test_duplicate_rate_calculation(self, action, source_data):
        ...
        duplicate_mapped_data = pd.DataFrame({
            'protein_id': ['P12345', 'P67890', 'P11111', 'P22222'],
            'uniprot_id': ['P12345', 'P67890', 'P67890', 'P22222']  # P67890 appears twice
        })
        
        context = {
            'datasets': {
                'source': source_data,
                'mapped': duplicate_mapped_data
            }
        }
        ...
        assert abs(result.individual_metrics['duplicate_rate'] - expected_duplicate_rate) < 0.01
    ...
    async def test_ambiguity_rate_calculation(self, action):
        ...
        source_data = pd.DataFrame({
            'protein_id': ['P12345', 'P12345', 'P67890', 'P11111'],  # P12345 appears twice
            'name': ['Protein A1', 'Protein A2', 'Protein B', 'Protein C']
        })
        
        mapped_data = pd.DataFrame({
            'protein_id': ['P12345', 'P12345', 'P67890', 'P11111'],
            'uniprot_id': ['Q11111', 'Q22222', 'P67890', 'P11111']  # P12345 maps to 2 different targets
        })
        ...
        assert abs(result.individual_metrics['ambiguity_rate'] - expected_ambiguity_rate) < 0.01
    ...
    @pytest.mark.asyncio
    async def test_overall_quality_score_calculation(self, action, source_data, mapped_data):
        ...
        params = CalculateMappingQualityParams(
            ...
            mapped_id_column='uniprot_id',
            confidence_column='confidence',
            metrics_to_calculate=['match_rate', 'coverage', 'confidence_distribution', 'identifier_quality']
        )
    ...
    @pytest.mark.asyncio
    async def test_confidence_threshold_parameter(self, action, source_data, mapped_data):
