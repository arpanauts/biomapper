...
async def test_get_ontology_type_success(metadata_query_service, mock_session):
    ...
    mock_result.scalar_one_or_none.return_value = "GENE_NAME"
...
async def test_get_endpoint_not_found(metadata_query_service, mock_session):
    ...
    # Call the method - it should return None, not raise an error
    result = await metadata_query_service.get_endpoint(mock_session, "nonexistent_endpoint")
...
async def test_get_endpoint_properties_success(metadata_query_service, mock_session):
    ...
    # Call the method - now using endpoint_name instead of endpoint_id
    result = await metadata_query_service.get_endpoint_properties(mock_session, "test_endpoint")
...
async def test_get_ontology_preferences_success(metadata_query_service, mock_session):
    ...
    # Call the method - using endpoint_name, not endpoint_id
