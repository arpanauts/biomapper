...
class TestExecuteMappingPathParams:
    ...
    def test_minimal_params_creation(self):
        ...
        params = ExecuteMappingPathParams(
            identifier="BRCA2", source_type="hgnc", target_type="uniprot"
        )
    ...
    def test_missing_required_fields(self):
        ...
        with pytest.raises(ValueError, match="identifier"):
            ExecuteMappingPathParams(source_type="uniprot", target_type="ensembl")

        with pytest.raises(ValueError, match="source_type"):
            ExecuteMappingPathParams(identifier="P12345", target_type="ensembl")

        with pytest.raises(ValueError, match="target_type"):
            ExecuteMappingPathParams(identifier="P12345", source_type="uniprot")
    ...
    def test_empty_identifier_handling(self):
        ...
        with pytest.raises(ValueError, match="identifier"):
            ExecuteMappingPathParams(
                identifier="", source_type="uniprot", target_type="ensembl"
            )
    ...
    def test_source_target_validation(self):
        ...
        with pytest.raises(ValueError, match="source_type.*target_type"):
            ExecuteMappingPathParams(
                identifier="P12345", source_type="uniprot", target_type="uniprot"
            )
