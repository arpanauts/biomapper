...
class TestHMDBQdrantLoader:
    ...
    @pytest.mark.asyncio
    async def test_load_metabolites_handles_errors_gracefully(
        self, loader, mock_processor
    ):
