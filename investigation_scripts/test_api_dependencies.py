...
class APIConnectivityTester:
    ...
    async def test_api_connectivity(self, api_name: str, config: Dict[str, Any]) -> APITestResult:
    ...
    def analyze_results(self, results: Dict[str, APITestResult]) -> Dict[str, Any]:
        ...
        analysis['average_response_time'] = total_response_time / len(results) if results else 0.0
        analysis['reliability_score'] = analysis['successful_apis'] / analysis['total_apis'] * 100 if results else 0.0
        
        return analysis

def generate_api_dependency_report(results: Dict[str, APITestResult], analysis: Dict[str, Any]) -> str:
...
async def main():
    ...
    async with APIConnectivityTester() as tester:
        ...
        print(f"API connectivity test complete.")
        print(f"Results: {analysis['successful_apis']}/{analysis['total_apis']} APIs accessible")
