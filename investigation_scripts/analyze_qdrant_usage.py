...
if __name__ == "__main__":
    ...
    print(
        "Qdrant dependency analysis complete. Report saved to /tmp/qdrant_dependency_report.md"
    )
    print(
        f"Found {len(usage_data['strategies_affected'])} affected strategies and {len(usage_data['actions_using_qdrant'])} actions using Qdrant"
    )
