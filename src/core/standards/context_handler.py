...
class UniversalContext:
    ...
    def __init__(self, context: Union[Dict, Any, None] = None):
        ...
        if not self._is_dict:
            # Check for ContextAdapter patterns (ensure methods are callable)
            if (hasattr(self._context, "get_action_data") and callable(getattr(self._context, "get_action_data", None)) and
                hasattr(self._context, "set_action_data") and callable(getattr(self._context, "set_action_data", None))):
