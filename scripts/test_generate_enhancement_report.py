...
async def main():
    ...
    context = {
        "metrics.baseline": {
            ...
            "avg_confidence": 0.87,
            "execution_time": 18.3,
            "match_distribution": {"exact": 1225, "fuzzy": 350},
        },
        "metrics.api": {
            "stage": "api_enhanced",
            ...
            "cache_hits": 415,
            "execution_time": 48.7,
            "enrichment_sources": {"pubchem": 301, "chebi": 178, "hmdb": 98},
        },
        "metrics.vector": {
    ...
    print("\nReport Summary:")
    print("- Initial match rate: 45.0%")
    print("- Final match rate: 71.1%")
    print("- Overall improvement: 58% relative improvement")
    print("- Total metabolites: 3,500")
    print("- Total matched: 2,489")
