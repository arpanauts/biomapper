...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Analyze KEGG compound structure and DBLINKS.")
    parser.add_argument("--kegg-id", default="C00031", help="KEGG compound ID to analyze")
