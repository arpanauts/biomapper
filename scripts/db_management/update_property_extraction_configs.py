...
try:
    ...
    if "entity_type" not in columns:
        ...
        cursor.execute(
            "ALTER TABLE property_extraction_configs ADD COLUMN entity_type TEXT DEFAULT 'metabolite'"
        )
    ...
    if null_configs:
        ...
        cursor.execute(
            "UPDATE property_extraction_configs SET entity_type = 'metabolite' WHERE entity_type IS NULL"
        )
        print(
            f"Updated {cursor.rowcount} property extraction configs with default entity_type = 'metabolite'"
        )
