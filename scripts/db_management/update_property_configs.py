...
try:
    ...
    cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='property_configs'")
    ...
    if "entity_type" not in columns:
        ...
        cursor.execute("ALTER TABLE property_configs ADD COLUMN entity_type TEXT DEFAULT 'metabolite'")
    ...
    if null_configs:
        ...
        cursor.execute("UPDATE property_configs SET entity_type = 'metabolite' WHERE entity_type IS NULL")
        print(f"Updated {cursor.rowcount} property configs with default entity_type = 'metabolite'")
