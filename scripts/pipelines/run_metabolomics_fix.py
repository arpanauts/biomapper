...
async def main():
    parser = argparse.ArgumentParser(description="Run metabolomics pipeline with fixes")
    parser.add_argument(
        "--config",
        type=Path,
        default=Path(__file__).parent.parent.parent
        / "configs"
        / "three_way_metabolomics_mapping_strategy.yaml",
    ...
    try:
        ...
        result = run_strategy(strategy_name=str(args.config), parameters=parameters)
