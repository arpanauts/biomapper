...
# Direct file paths - Updated to use authoritative MAPPING_ONTOLOGIES source
INPUT_FILE = "/procedure/data/local_data/MAPPING_ONTOLOGIES/arivale/metabolomics_metadata.tsv"
