...
class Checkpoint(Base):
    ...
    description = Column(Text, nullable=True)
    checkpoint_type = Column(String(50), default="automatic")  # automatic, manual, pre_error
...
class JobEvent(Base):
    ...
    # Event details
    event_type = Column(String(50), nullable=False)  # progress, log, error, complete, checkpoint
