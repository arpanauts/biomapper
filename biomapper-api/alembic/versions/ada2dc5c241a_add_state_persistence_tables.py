...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_events_delivered", "job_events", ["delivered", "timestamp"], unique=False
    )
    op.create_index(
        "idx_events_job_type", "job_events", ["job_id", "event_type"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_job_events_timestamp"), "job_events", ["timestamp"], unique=False
    )
    op.create_table(
        "jobs",
    ...
    op.create_index(
        "idx_jobs_strategy_status", "jobs", ["strategy_name", "status"], unique=False
    )
    op.create_index(op.f("ix_jobs_created_at"), "jobs", ["created_at"], unique=False)
    op.create_index(op.f("ix_jobs_status"), "jobs", ["status"], unique=False)
    op.create_index(
        op.f("ix_jobs_strategy_name"), "jobs", ["strategy_name"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        "idx_checkpoints_job_step",
        "execution_checkpoints",
        ["job_id", "step_index"],
        unique=False,
    )
    op.create_index(
        op.f("ix_execution_checkpoints_created_at"),
        "execution_checkpoints",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_execution_checkpoints_expires_at"),
        "execution_checkpoints",
        ["expires_at"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_logs_job_level", "execution_logs", ["job_id", "log_level"], unique=False
    )
    op.create_index(
        "idx_logs_timestamp", "execution_logs", ["created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_execution_logs_job_id"), "execution_logs", ["job_id"], unique=False
    )
    op.create_table(
        "execution_steps",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "idx_steps_job_index", "execution_steps", ["job_id", "step_index"], unique=True
    )
    ...
    op.create_index(
        "idx_results_expires", "result_storage", ["expires_at"], unique=False
    )
    op.create_index(
        "idx_results_job_key",
        "result_storage",
        ["job_id", "step_index", "result_key"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_execution_checkpoints_expires_at"), table_name="execution_checkpoints"
    )
    op.drop_index(
        op.f("ix_execution_checkpoints_created_at"), table_name="execution_checkpoints"
    )
