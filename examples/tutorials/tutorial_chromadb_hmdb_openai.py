...
def parse_llm_response(response_text: str) -> tuple[str, str, float, str, str, float]:
    ...
    try:
        ...
        return mapped_hmdb_id, mapped_hmdb_name, mapped_confidence, best_guess_hmdb_id, best_guess_hmdb_name, best_guess_confidence, explanation
...
"""
        ...
        mapped_id, mapped_name, mapped_conf, best_guess_id, best_guess_name, best_guess_conf, explanation = parse_llm_response(response.choices[0].message.content)
