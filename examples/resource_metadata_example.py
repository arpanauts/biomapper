...
from biomapper.mapping.metadata.initialize import initialize_metadata_system, get_metadata_db_path
...
async def main():
    ...
    with metadata_manager:
        ...
        cache_id = metadata_manager.register_resource(
            ...
            resource_type="cache",
            connection_info={
                "db_path": "/home/ubuntu/.biomapper/mappings.db"
            },
    ...
    logger.info("In a real implementation, this would use the adapters to query resources.")
